...
<?php $__env->startSection('content'); ?>
  <div class="page-header clear-filter" filter-color="orange">
    ...
    <div class="content">
      ...
      <?php elseif(!$candidato->CAN_VICE): ?> <!-- Verifica se existe não existe candidatos -->
        <div class="container">
          <br><br><br><br><br>
          <h3 style="font-weight: bold;"> A votação <span style="color:yellow;">ainda</span></h3>
          <h4>não foi iniciada</h4>
        ...
        <div class="container">
          ...
          <div class="col-md-4 ml-auto mr-auto">
            <div class="card card-login card-plain"> 
              <div class="card">
                  <img class="card-img-top" src="<?php echo e(url('storage/candidatos/'.$candidato->CAN_IMAGEM)); ?>" alt="" id="logomain" id="imgcandidato">
                  <h4 class="card-title" style="color:black; margin-bottom: 0em; margin-top: 0px; font-weight: bold;"> <?php echo e($candidato->CAN_NOME); ?> Presidente</h4>
                  <h4  style="color:black; margin-bottom: 0em; margin-top: 0px;"> <?php echo e($candidato->CAN_VICE); ?> Vice </h4>
